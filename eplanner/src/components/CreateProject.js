...
function CreateProject() {
  ...
  if (
    ...
    projectType === "Argument Paper" ||
    projectType === "Exploratory Paper" ||
    projectType === "Reflective Paper" ||
    projectType === "Persuasive Essay" ||
    projectType === "Analytical Paper" ||
    projectType === "Argumentative Essay"
  ) {
    projectLength = 10;
    projectTime = 20;
    minCompletion = 2;
    ...
    projectType === "Executive/Business Report" ||
    projectType === "Summary Report" ||
    projectType === "Scientific Report" ||
    projectType === "Technical Report" ||
    projectType === "Evaluation Report"
  ) {
    projectLength = 5;
    projectTime = 10;
    minCompletion = 1;
  ...
  const selectWorkPattern = () => {
    ...
    console.log(
      "Hours per week required to complete project: " + hoursPerWeekIdeal
    );
    ...
    if (time <= 0) {
      ...
      console.log(
        "Error, time is less than minimum required completion time in weeks."
      );
    } else {
      if (!whenBest || !inBest || !onBest) {
        /* Stopgap, need to validate radio button inputs beforehand. Keep this as a catch-all though.*/
        console.log(
          "Error, radio button inputs are invalid. Below is each of the three in order."
        );
  ...
  const setOptionsWithHoursPerWeekLessThanEqualToFour = () => {
    ...
    if (whenBest === "chunks") {
      ...
      if (onBest === "weekdays") {
        ...
        for (
          hour = 0 + offset + storeRand;
          hour < 2 + offset + storeRand;
          hour++
        ) {
          // Hours distributed to add up to 4.
      ...
      <Stack spacing={2} sx={{ width: "100%", pr: 3 }}>
        ...
        >
          ...
          <TextField
            ...
            id="budget"
            label="Budget"
            placeholder="Enter the Budget for this Project (Optional)"
            fullWidth
          />
          <br />
          <br />
          ...
          <TextField
            onChange={handleNumPeopleUpdate}
            value={numPeople}
            id="numPeople"
            label="Number of People"
            placeholder="Enter the Number of People on this Project"
            fullWidth
          />
          <br />
        </Box>
        ...
        <Box sx={{ maxWidth: 350 }}>
          ...
          >
            ...
            >
              <FormControlLabel
                value="chunks"
                control={<Radio />}
                label="I do big chunks of work at a time."
              />
              <FormControlLabel
                value="space"
                control={<Radio />}
                label="I space the work out."
              />
            </RadioGroup>
            <FormHelperText>Field is required</FormHelperText>
            <br />
          ...
          <FormControl
            sx={{ mt: 3, borderBottom: 1, borderColor: "lightgray" }}
            fullWidth
          >
            <FormLabel sx={{ color: "black", fontWeight: "bold" }} id="inBest">
          ...
          <FormControl
            ...
            fullWidth
          >
            <FormLabel sx={{ color: "black", fontWeight: "bold" }} id="onBest">
              I Prefer Working On...
            </FormLabel>
            <RadioGroup
            ...
            >
              ...
              <FormControlLabel
                value="both"
                control={<Radio />}
                label="Both Weekdays and Weekends."
              />
            </RadioGroup>
            <FormHelperText>Field is required</FormHelperText>
            <br />
        ...
        >
          <TextField
            ...
            helperText={
              startDateError ? "Select a date after today's date." : ""
            }
          />
          ...
          <TextField
            ...
            error={endDateError}
            helperText={
              endDateError ? "Select a date after your chosen start date." : ""
            }
          />
          <FormHelperText sx={{ ml: 2 }}>Field is required</FormHelperText>
          <br />
          {tooShortError ? (
            <div className="error">
              Your selected project type requires {minCompletion} week(s) to
              complete. Please choose dates that are farther apart. <br />
              <br />
            </div>
          ) : (
            <></>
          ...
          <TextField
            ...
            label="Project Goal"
            type="text"
            placeholder="Enter your Goal for this Project (Optional)"
            fullWidth
          />
        </Box>
        <Box>
        ...
        >
          ...
          {disabler ? (
            <div className="error">
              You have left required fields empty. Please fill in the fields
              that are marked required. <br />
              <br />
            </div>
          ) : (
            <></>
