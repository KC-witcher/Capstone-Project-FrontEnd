...
function SignUp() {
  ...
  return (
    <Stack sx={{ p: 3, maxWidth: 350 }} spacing={3}>
      ...
      <item>
        <TextField id="Password" label="Password" type="password" placeholder="Enter a Password" onChange={(e) => {
              setPassword(e.target.value);
           }} fullWidth />
      </item>
      <item>
        <TextField id="ConfirmPassword" label="Confirm Password" type="password" placeholder="Re-Enter a Password" onChange={(e) => {
              setPasswordAgain(e.target.value);
           }} error={passwordError} helperText={passwordError ? "Passwords do not match, please confirm your password!" : ""} fullWidth />
      </item>
      <item>
        <TextField id="fName" label="First Name" type="text" placeholder="Enter your First Name" onChange={(e) => {
              setFirstName(e.target.value);
           }} fullWidth />
      </item>
      <item>
        <TextField id="lName" label="Last Name" type="text" placeholder="Enter your Last Name" onChange={(e) => {
